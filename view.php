...
<div>
    ...
    <a type="button" class="btn <?php if ($render == 'social') {echo 'inactive" disabled="true';} ?>" id="btn-date-scope"  >Odœwie¿</a>
<?php
...
if ($adminAcces || $set->del){echo"<a id=btn-del-group class='btn btn-danger' >Usuñ</a>\n";}
...
';} else { 										// def user function
	echo '        $(".event-add").click(function(){alert("Brak uprawnieñ...");});
        $(".del-event").click(function(){alert("Brak uprawnieñ...");});
